...
{ 
	funcao inicio () 
	{ 
		real horatrabalhada, horaextra, totalhorastrabalhadas, totalhorasextras, salario
		...
		totalhorastrabalhadas = horatrabalhada * 10
		totalhorasextras = horaextra * 15
				
		escreva("\nSeu Salário anual é de: ",totalhorastrabalhadas + totalhorasextras,"\n")
	} 
}
